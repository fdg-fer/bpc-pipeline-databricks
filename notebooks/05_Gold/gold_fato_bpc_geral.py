...
# MAGIC %sql
# MAGIC
# MAGIC create or replace table portfolio_inss.gold.gold_fato_bpc_geral (
# MAGIC   WITH 
...
# MAGIC     GROUP BY competencia, beneficio, tipo_despacho
# MAGIC   ),
# MAGIC
...
# MAGIC     FROM portfolio_inss.silver.silver_bpc_concessoes
# MAGIC     WHERE dt_inicio_beneficio >= '2024-01-01'
# MAGIC     GROUP BY competencia, beneficio
# MAGIC   )
# MAGIC
# MAGIC   -- Tabela final
# MAGIC   SELECT
